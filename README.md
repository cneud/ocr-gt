# ocr-gt
OCR Ground Truth Resources *--> see either [YAML](https://github.com/cneud/ocr-gt/blob/master/ocr-gt.yml) or [JSON](https://github.com/cneud/ocr-gt/blob/master/ocr-gt.json) for up-to-date version <--*
